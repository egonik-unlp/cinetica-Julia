...
# ╔═╡ c3ae7998-68e8-11ec-2499-4f1505a7338c
begin
using Plots, PlutoUI, DataFrames,LaTeXStrings,PlotlyJS
plotlyjs()
end

# ╔═╡ a2ca34bd-28d0-4136-8fd4-157775ce9d09
L"""
\require{mhchem}
""";

# ╔═╡ c2fd5ff2-3ca4-4539-8d80-877172271145
L"""
\begin{align}
\ce{[Cr2O7^2-]} &= \ce{[Cr2O7^2-]_0}-k't\\

\

\ln{\ce{[Cr2O7^2-]}} &= \ln{\ce{[Cr2O7^2-]}}_0 - k't \\

\


\dfrac{1}{\ce{[Cr2O7^2-]}} &= \dfrac{1}{\ce{[Cr2O7^2-]}_0} + k´t

\end{align}
"""

# ╔═╡ 5b854d6b-9dcf-4fa9-b7c5-6424a1662c32
md"""

Dicromato Inicial = $(@bind Cr₂O₇₀ Slider(0.1:0.1:1|> collect, show_value=:true)) \

k =  $(@bind k Slider(.1:.1:1, show_value=:true)) \
	
$(@bind ti Clock(1,:true)) Pasaron $ti segundos  

$(@bind tuki Button("Reiniciar"))
"""


# ╔═╡ 685fd04b-932c-4690-aae4-a30d1f69e559
begin
	tuki
	l = @layout [a b]
	p0=Plots.scatter([0],[0], label="Cinetica de Orden 0", markercolor=:blue)
    p2=	Plots.scatter([0],[0], label="Cinetica de Orden 2", markercolor=:brown)
	Cr₂O₇O0=[]
	Cr₂O₇O1=[]
	Cr₂O₇O2=[]
	t=[]
...
# ╔═╡ 0ffc2d64-1490-40db-b95b-9a6936431da1
begin
	append!(Cr₂O₇O0,Cr₂O₇₀ - k * ti) 
	# append!(Cr₂O₇O1,log10(Cr₂O₇₀) - k * ti)
	append!(Cr₂O₇O2,1/Cr₂O₇₀ + k * ti)
	append!(t,ti)
	scatter!(p0,[ti],[Cr₂O₇₀ - k * ti], label=:false,markercolor=:blue)
	# scatter!(t,log10.(Cr₂O₇O1), label=:false, markercolor=:red)
	scatter!(p2,[ti],[1/Cr₂O₇₀ + k * ti],label=:false, markercolor=:brown)
	plot!(p0,p2, layout=l)
end
